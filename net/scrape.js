...
async function fetchProxies() {
  for (const site of raw_proxy_sites) {
    try {
      ...
      console.error(`Failed to fetch from ${site}:`, error.message);
    }
  }
  ...
  console.log(`Successfully updated ${totalProxies} proxies`);
  return totalProxies;
}

module.exports = {
  fetchProxies,
  getTotalProxies: () => totalProxies, // Function to access total proxies
};